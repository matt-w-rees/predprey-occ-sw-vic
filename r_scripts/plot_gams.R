# THIS SCRIPT PLOTS THE RESULTS OF THE OCCURRENCE MODELS IN THE PREVIOUS 'gams.R' SCRIPT, AND REQUIRE THAT SCRIPT TO BE RUN FIRST SO VARIABLES ARE LOADED IN THE ENVIRONMENT
# Matthew Rees
